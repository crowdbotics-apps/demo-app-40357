...
const demoappAPI = axios.create({
  baseURL: "https://demo-app-40357.botics.co",
  headers: { Accept: "application/json", "Content-Type": "application/json" }
})
function api_v1_test_list(payload) {
  return demoappAPI.get(`/api/v1/test/`)
}
function api_v1_test_create(payload) {
  return demoappAPI.post(`/api/v1/test/`, payload.data)
}
...
function api_v1_test_retrieve(payload) {
  return demoappAPI.get(`/api/v1/test/${payload.id}/`)
}
function api_v1_test_update(payload) {
  return demoappAPI.put(`/api/v1/test/${payload.id}/`, payload.data)
}
function api_v1_test_partial_update(payload) {
  return demoappAPI.patch(`/api/v1/test/${payload.id}/`, payload.data)
}
function api_v1_test_destroy(payload) {
  return demoappAPI.delete(`/api/v1/test/${payload.id}/`)
}
